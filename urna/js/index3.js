...
function votar(){
    ...
    if(valorVoto == 1){
        ...
        alert("O seu voto no candidato Tarcísio Freitas foi computado")
    }
    if(valorVoto == 2){
        candidato2 = candidato2 + 1
        alert("O seu voto no candidato Fernando Haddad foi computado")
    }
    if(valorVoto == 3){
        candidato3 = candidato3 + 1
        alert("O seu voto na candidato Elvis Cezar foi computado ")
    }
    if(valorVoto == 4){
        candidato4 = candidato4 + 1
        alert("O seu voto na candidata Rodrigo Garcia foi computado")
    }
    if(valorVoto == 5){
        nulo = nulo + 1
